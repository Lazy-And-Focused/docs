...
- [3. Функции и методы](#3funcs-and-methods)
- [4. Классы](#classes)
- [5. Циклы](#loops)
...
2. **Если** переменная/поле содержит булево значение, то наименование должно содержать прошедшее время: `activated`, `available`, `outdated`. **Если** это невозможно, то добавляйте префикс is: `isAdmin`, `isUser`.
...
12. **Желательно** использовать `const enum`, и не использовать `enum`
