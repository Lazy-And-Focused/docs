---
title: Соглашение о код-стайле в команде LAF
...
6. <span id="classes-6" /> Методы класса **не должны** быть объявлены через лямбда-синтаксис. [Чё?](#exp-4_6)
...
1. <span id="code-12-1" /> **Желательно** использовать `const enum`, и не использовать `enum` [Что?](#exp-7_12_1)
...
- <span id="exp-7_12_1" /> 7.12.1  “Нельзя использовать обычные `enum`”
...
В итоге лучше использовать `const enum`
